      ...
      <nav aria-label="Page navigation example" className="py-3">
        <ul className="inline-flex -space-x-px text-sm">
          ...
          <li className="page-item active">
            <a
              href="#"
              className="flex items-center justify-center px-3 h-8 text-blue-600 border border-gray-300 bg-blue-50 hover:bg-blue-100 hover:text-blue-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white rounded-e-lg"
            >
              Quiz
            </a>
          </li>
            ...
            {canMap ? (
              <>
                <div>
                  ...
                  <h3 className="text-xl">{`${lesson.name} Lesson Quiz`}</h3>
                  <p>
